...
\node[label=above:{Figure \ref{figLanguages}}] (reception-in) at (0,0) {\includegraphics[width = 100pt]{Images/Base_1_Languages.png}};

\node[label=below:{Figure \ref{figCheckInOut}}] (check-in-out) at (5,-5) {\includegraphics[width = 100pt]{Images/Basic_2_option.png}};
\node[label=below:{Figure \ref{figBarLogin}}] (bar-login) at (-5,-5) {\includegraphics[width = 100pt]{Images/Services_2_Login.png}};
\node[label=below:{Figure \ref{figRoom}}] (room) at (0,-5) {\includegraphics[width=100pt]{Images/Services_3_Selection.png}};

\node[label=below:{Figure \ref{figCheckIn}}] (check-in) at (5,-10) {\includegraphics[width = 100pt]{Images/Basic_3_Check-in.png}};
\node[label=below:{Figure \ref{figServices}}] (services) at (-5,-10) {\includegraphics[width = 100pt]{Images/Services_4_Services.png}};
\node[label=below:{Figure \ref{figCheckOut}}] (check-out) at (0,-10) {\includegraphics[width=100pt]{Images/Both_6_Check-out.png}};

\node[label=below:{Figure \ref{figCheckInWrong}}] (check-in-wrong) at (6,-15) {\includegraphics[width = 100pt]{Images/Basic_3_Check-in__wrong.png}};
\node[label=below:{Figure \ref{figServicesOrder}}] (services-order) at (-6,-15) {\includegraphics[width = 100pt]{Images/Services_5_Order-Food.png}};
\node[label=below:{Figure \ref{figGoodbye}}] (goodbye) at (-2,-15) {\includegraphics[width = 100pt]{Images/Both_7_Goodbye.png}};
\node[label=below:{Figure \ref{figCheckInDone}}] (check-in-done) at (2,-15) {\includegraphics[width=100pt]{Images/Basic_4_CheckIn_Done.png}};
